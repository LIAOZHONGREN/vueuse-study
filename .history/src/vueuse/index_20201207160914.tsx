...
import {
    ...
    useBrowserLocation, useClipboard, useCssVar, useElementSize
} from '@vueuse/core'
...
const UseElementSize = defineComponent({
    setup() {
        ...
        return () => (
            <div>
                <span>useElementSize:</span><br/>
                <textarea style={{ resize: 'both', backgroundColor: 'rgba(0,0,0,0)', padding: '5px', border: '1px solid rgba(0,0,0,0.2)', width: '200px' }} disabled={true}>
...
export default defineComponent({
    ...
    components: {
        ...
        UseParallax, UseWindowScroll, UseWindowSize, UseBrowserLocation, UseClipboard, UseCssVar, UseElementSize
    },
    setup() {
