...
import {
    ...
    useBrowserLocation, useClipboard, useCssVar, useElementSize, useEventListener, useFavicon, useFullscreen, useMediaQuery, useMutationObserver, usePermission
} from '@vueuse/core'
...
export default defineComponent({
    ...
    components: {
        ...
        UseMediaQuery, UseMutationObserver,UsePermission
    },
    setup() {
