...
import {
    ...
    useBrowserLocation, useClipboard
} from '@vueuse/core'
...
const UseClipboard = defineComponent({
    setup() {
        ...
        return () => (
            <div>
                <span>:useClipboard</span><br />
                <span>{text.value}</span><br />
                <input type="text" v-model={inputRef} placeholder='输入要复制到剪切板的文本' /><br />
...
export default defineComponent({
    ...
    components: {
        ...
        UseParallax, UseWindowScroll, UseWindowSize, UseBrowserLocation, UseClipboard
    },
    setup() {
