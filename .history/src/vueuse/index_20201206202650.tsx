...
import {
    ...
    onClickOutside, onStartTyping, useBattery, useDeviceLight, useDeviceMotion, useDeviceOrientation, useDevicePixelRatio
} from '@vueuse/core'
...
const UseDevicePixelRatio = defineComponent({
    setup() {
        ...
        return () => (
            <div>
                <span>useDevicePixelRatio:</span>
                <div>{pixelRatio.value}</div>
            </div>
        )
    }
})
...
export default defineComponent({
    ...
    components: {
        ...
        OnStartTyping, UseBattery, UseDeviceLight, UseDeviceMotion, UseDeviceOrientation,UseDevicePixelRatio
    },
    setup() {
