...
import { useVModel, debouncedWatch, ignorableWatch, pausableWatch, throttledWatch, when, useCounter, useLocalStorage, useSessionStorage, useStorage, useToggle, useMouse } from '@vueuse/core'
...
const UseToggle = defineComponent({
    setup() {
        ...
        return () => (
            < div >
                <span>useToggle:</span><br />
                <input type='checkbox' name="toggle" checked={checked.value} onClick={toggle} />
            </div >
        )
    }
})
...
export default defineComponent({
    name: 'VueuseStudy',
    components: { UseVModel, DebouncedWatch, IgnorableWatch, PausableWatch, UseMouse, When, UseCounter, CreateGlobalState, UseLocalStorage, UseSessionStorage, UseStorage, UseToggle },
    setup() {
