...
import {
    ...
    useBrowserLocation, useClipboard, useCssVar
} from '@vueuse/core'
...
const UseCssVar = defineComponent({
    setup() {
        ...
        return { elRef, color, switchColor, }
    },
    render() {
        return (
            <div>
                <p ref='elRef' style='--color:#7fa998; color: var(--color);'>Sample text, {this.color}</p>
...
export default defineComponent({
    ...
    components: {
        ...
        UseParallax, UseWindowScroll, UseWindowSize, UseBrowserLocation, UseClipboard, UseCssVar
    },
    setup() {
