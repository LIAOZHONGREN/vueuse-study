...
export default defineComponent({
    ...
    components: {
        ...
        UseParallax, UseWindowScroll, UseWindowSize, UseBrowserLocation, UseClipboard, UseCssVar, UseElementSize, UseEventListener, UseFavicon, UseFullscreen, UseMediaQuery
    },
    setup() {
