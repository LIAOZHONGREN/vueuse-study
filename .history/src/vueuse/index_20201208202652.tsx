...
import {
    ...
    asyncComputed, useAsyncState, useRefHistory, biSyncRef, controlledComputed, extendRef
...
const ExtendRef = defineComponent({
    setup() {
        ...
        return () => (
            <div>
                <span>extendRef:向响应式值添加额外的属性,如果新添加的属性也是响应式的,修改此属性值将会响应到此属性的原始的响应变量,并将触发组件更新。如果不是响应式的那属性为只读属性</span><br />
...
export default defineComponent({
    ...
    components: {
        ...
        UseTimeout, UseTimeoutFn, AsyncComputed, UseAsyncState, UseRefHistory, BiSyncRef, ControlledComputed, ExtendRef
    },
    setup() {
