...
import {
    ...
    onClickOutside, onStartTyping, useBattery, useDeviceLight, useDeviceMotion, useDeviceOrientation, useDevicePixelRatio, useDocumentVisibility
} from '@vueuse/core'
...
const UseDocumentVisibility = defineComponent({
    setup() {
        ...
        watch(visibility, () => { console.log(visibility.value) })
        return () => (
            <div>
                <span>useDocumentVisibility:反应性追踪 document.visibilityState</span><br />
                <div>visibility:{visibility.value}</div>
            </div>
        )
    }
})
...
export default defineComponent({
    name: 'VueuseStudy',
    components: {
        UseVModel, DebouncedWatch, IgnorableWatch, PausableWatch, UseMouse, When, UseCounter,
