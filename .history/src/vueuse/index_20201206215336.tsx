...
import {
    ...
    useDevicePixelRatio, useDocumentVisibility, useElementVisibility, useGeolocation, useIdle, useIntersectionObserver
} from '@vueuse/core'
...
const UseIntersectionObserver = defineComponent({
    setup() {
        const elRef = ref<Element>(null)
        const { isSupported, stop } = useIntersectionObserver(elRef, () => {console.log('000') })
        return () => (
            <div ref={elRef}>
...
export default defineComponent({
    ...
    components: {
        ...
        UseElementVisibility, UseGeolocation, UseIdle,UseIntersectionObserver
    },
    setup() {
