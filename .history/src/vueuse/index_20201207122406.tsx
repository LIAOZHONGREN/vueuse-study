...
import {
    ...
    useMouseInElement, useNetwork, useOnline
} from '@vueuse/core'
...
export default defineComponent({
    ...
    components: {
        ...
        UseElementVisibility, UseGeolocation, UseIdle, UseIntersectionObserver, UseMouse, UseMouseInElement, UseNetwork,UseOnline
    },
    setup() {
