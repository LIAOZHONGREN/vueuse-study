...
import {
    ...
    useDevicePixelRatio, useDocumentVisibility, useElementVisibility, useGeolocation
} from '@vueuse/core'
    ...
    setup() {
        ...
        return () => (
            <div>
                ...
                <div>isSupported:{isSupported}</div><br />
                <div>coords:{JSON.stringify(unref(coords))}</div><br />
                <div>locatedAt:{locatedAt.value}</div><br />
                <div>error:{JSON.stringify(unref(error))}</div><br />
            </div>
        )
    }
})
...
export default defineComponent({
    ...
    components: {
        ...
        UseElementVisibility, UseGeolocation
    },
    setup() {
