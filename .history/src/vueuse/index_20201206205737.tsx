...
import {
    ...
    useDevicePixelRatio, useDocumentVisibility, useElementVisibility
} from '@vueuse/core'
...
export default defineComponent({
    ...
    components: {
        ...
        OnStartTyping, UseBattery, UseDeviceLight, UseDeviceMotion, UseDeviceOrientation, UseDevicePixelRatio, UseDocumentVisibility,UseElementVisibility
    },
    setup() {
