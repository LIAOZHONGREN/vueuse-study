...
import {
    ...
    asyncComputed, useAsyncState, useRefHistory, biSyncRef, controlledComputed, extendRef, makeDestructurable
...
export default defineComponent({
    ...
    components: {
        ...
        UseTimeout, UseTimeoutFn, AsyncComputed, UseAsyncState, UseRefHistory, BiSyncRef, ControlledComputed, ExtendRef,MakeDestructurable
    },
    setup() {
