...
import {
    ...
    useBrowserLocation, useClipboard, useCssVar, useElementSize, useEventListener, useFavicon, useFullscreen, useMediaQuery, useMutationObserver, usePermission, usePreferredLanguages
} from '@vueuse/core'
...
const UsePreferredLanguages = defineComponent({
    setup() {
        ...
        return () => (
            <div>
                <span>usePreferredLanguages:</span><br />
                <span>{JSON.stringify(languages.value)}</span>
            </div>
        )
    }
})
...
export default defineComponent({
    ...
    components: {
        ...
        UseMediaQuery, UseMutationObserver, UsePermission, UsePreferredLanguages
    },
    setup() {
