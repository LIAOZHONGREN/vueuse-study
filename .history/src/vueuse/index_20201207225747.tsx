...
import {
    ...
    useBrowserLocation, useClipboard, useCssVar, useElementSize, useEventListener, useFavicon, useFullscreen, useMediaQuery, useMutationObserver, usePermission, usePreferredLanguages, useResizeObserver
} from '@vueuse/core'
...
export default defineComponent({
    ...
    components: {
        ...
        UseMediaQuery, UseMutationObserver, UsePermission, UsePreferredLanguages,UseResizeObserver
    },
    setup() {
