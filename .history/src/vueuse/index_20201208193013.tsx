...
import {
    ...
    asyncComputed, useAsyncState, useRefHistory, biSyncRef, controlledComputed
...
export default defineComponent({
    ...
    components: {
        ...
        UseTimeout, UseTimeoutFn, AsyncComputed, UseAsyncState, UseRefHistory, BiSyncRef, ControlledComputed
    },
    setup() {
