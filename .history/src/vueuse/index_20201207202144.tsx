...
import {
    ...
    useBrowserLocation, useClipboard, useCssVar, useElementSize, useEventListener, useFavicon, useFullscreen
} from '@vueuse/core'
...
const UseFullscreen = defineComponent({
    setup() {
        ...
        return () => (
            <div>
                <span>useFullscreen:</span><br />
                <div ref={elRef} style={{display:'flex',justifyContent:'venter',alignItems:'center',backgroundColor:'#eaff8f'}}>
