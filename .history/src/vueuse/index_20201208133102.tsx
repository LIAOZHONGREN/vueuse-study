...
import {
    ...
    useRafFn, useTimestamp, useTransition, TransitionPresets, useInterval
} from '@vueuse/core'
...
export default defineComponent({
    ...
    components: {
        ...
        UseMediaQuery, UseMutationObserver, UsePermission, UsePreferredLanguages, UseResizeObserver, UseTitle, UseRafFn, UseTimestamp, UseTransition,UseInterval
    },
    setup() {
