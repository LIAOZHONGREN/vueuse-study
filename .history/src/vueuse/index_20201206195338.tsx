...
export default defineComponent({
    ...
    components: {
        ...
        UseMouse, When, UseCounter, CreateGlobalState, UseLocalStorage, UseSessionStorage, UseStorage, UseToggle, OnClickOutside, OnStartTyping, UseBattery, UseDeviceLight
    },
    setup() {
