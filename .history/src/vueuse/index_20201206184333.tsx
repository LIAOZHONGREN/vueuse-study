...
import {
    ...
    onClickOutside, onStartTyping, useBattery
} from '@vueuse/core'
        ...
        return () => (
            <div>
                <div style={{ position: 'relative', width: '300px', height: '20px', borderRadius: '10px', backgroundColor: 'rgba(0,0,0,0.3)' }}>
                    <div style={{ position: 'absolute', width: `${level * 100}%`, height: '20px', borderRadius: '10px', backgroundColor: '#d3f261' }}>
                        <span style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)' }}>`${level * 100}%`</span>
                    </div>
                </div>
            </div>
        )
...
export default defineComponent({
    ...
    components: {
        ...
        UseMouse, When, UseCounter, CreateGlobalState, UseLocalStorage, UseSessionStorage, UseStorage, UseToggle, OnClickOutside, OnStartTyping, UseBattery
    },
    setup() {
