...
import {
    ...
    asyncComputed, useAsyncState, useRefHistory, biSyncRef, controlledComputed, extendRef, makeDestructurable, syncRef
...
export default defineComponent({
    ...
    components: {
        ...
        UseTimeout, UseTimeoutFn, AsyncComputed, UseAsyncState, UseRefHistory, BiSyncRef, ControlledComputed, ExtendRef, MakeDestructurable,SyncRef
    },
    setup() {
