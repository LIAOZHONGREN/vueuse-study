...
import {
    ...
    useDevicePixelRatio, useDocumentVisibility, useElementVisibility, useGeolocation, useIdle
} from '@vueuse/core'
...
const UseIdle = defineComponent({
    setup() {
        ...
        watch(idle, () => {
            ...
            idle.value ? secondsRef.value = 0 : timeout = setInterval(() => { secondsRef.value++;console.log('000') }, 1000)
        })
        return () => (
            <div>
                <span>useIdle:</span>
